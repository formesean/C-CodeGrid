...
function Loader() {
  let circle =
    "h-2 w-2 bg-transparent rounded-full border border-2 border-black dark:border-appWhiteHigh";
  let letter =
    "text-lg text-appBlack dark:text-appWhiteHigh font-semibold mr-1";
